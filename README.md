...
git branch backup-before-untrack

# 2) Stop tracking the folder but keep local files
git rm -r --cached brett_vanderblock_pandas

# 3) Commit the change
git add .gitignore
git commit -m "Stop tracking brett_vanderblock_pandas; add to .gitignore"
